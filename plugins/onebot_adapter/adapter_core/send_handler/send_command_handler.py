...
class SendCommandHandleClass:
    ...
    def handle_kick_members_command(
        args: Dict[str, Any], group_info: Optional[GroupInfo]
    ...
    def handle_set_group_name_command(
        args: Dict[str, Any], group_info: Optional[GroupInfo]
    ) -> Tuple[str, Dict[str, Any]]:
        """设置群名
    ...
    def handle_set_qq_profile_command(
        args: Dict[str, Any], group_info: Optional[GroupInfo]
    ) -> Tuple[str, Dict[str, Any]]:
        """设置账号信息
    ...
    def handle_set_msg_emoji_like_command(
        args: Dict[str, Any], group_info: Optional[GroupInfo]
    ) -> Tuple[str, Dict[str, Any]]:
        """处理给消息贴表情命令
    ...
    def handle_get_login_info_command(
        args: Dict[str, Any], group_info: Optional[GroupInfo]
    ) -> Tuple[str, Dict[str, Any]]:
        """获取登录号信息（Bot自身信息）
    ...
    def handle_get_stranger_info_command(
        args: Dict[str, Any], group_info: Optional[GroupInfo]
    ) -> Tuple[str, Dict[str, Any]]:
        """获取陌生人信息
    ...
    def handle_get_friend_list_command(
        args: Dict[str, Any], group_info: Optional[GroupInfo]
    ) -> Tuple[str, Dict[str, Any]]:
        """获取好友列表
    ...
    def handle_get_group_info_command(
        args: Dict[str, Any], group_info: Optional[GroupInfo]
    ) -> Tuple[str, Dict[str, Any]]:
        """获取群信息
    ...
    def handle_get_group_detail_info_command(
        args: Dict[str, Any], group_info: Optional[GroupInfo]
    ) -> Tuple[str, Dict[str, Any]]:
        """获取群详细信息
    ...
    def handle_get_group_list_command(
        args: Dict[str, Any], group_info: Optional[GroupInfo]
    ) -> Tuple[str, Dict[str, Any]]:
        """获取群列表
    ...
    def handle_get_group_at_all_remain_command(
        args: Dict[str, Any], group_info: Optional[GroupInfo]
    ) -> Tuple[str, Dict[str, Any]]:
        """获取群@全体成员剩余次数
    ...
    def handle_get_group_member_info_command(
        args: Dict[str, Any], group_info: Optional[GroupInfo]
    ) -> Tuple[str, Dict[str, Any]]:
        """获取群成员信息
    ...
    def handle_get_group_member_list_command(
        args: Dict[str, Any], group_info: Optional[GroupInfo]
    ) -> Tuple[str, Dict[str, Any]]:
        """获取群成员列表
    ...
    def handle_get_forward_msg_command(
        args: Dict[str, Any], group_info: Optional[GroupInfo]
    ) -> Tuple[str, Dict[str, Any]]:
        """获取合并转发消息
