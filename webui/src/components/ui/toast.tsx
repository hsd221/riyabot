...
const toastVariants = cva(
  'motion-toast group pointer-events-auto relative mx-auto flex w-full max-w-[min(420px,calc(100vw-2rem))] items-start justify-between gap-3 overflow-hidden rounded-[18px] border p-3.5 pr-10 shadow-[0_10px_28px_rgba(31,41,55,0.12),0_1px_1px_rgba(255,255,255,0.7)_inset] backdrop-blur-2xl sm:mx-0',
  {
    variants: {
      variant: {
        default:
          'border-black/[0.04] bg-white/[0.86] text-foreground dark:border-white/10 dark:bg-zinc-950/[0.86]',
        destructive:
